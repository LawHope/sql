...
//1.방식
                            ...
                            System.out.printf(fmt, m.userid, m.passwd);
                                                                   ...
                                                                   // 결과 :아이디 : 1234 비밀번호 : asdf 
                                                      


//2. 클래스의 멤버 변수 출력용 to String 메소드를 써보자
                                                System.out.println(m.toString());
                                                                  //결과 : {userid = '1234', passwd : 'asdf' }


//3. math 클래스 수학 연산을 위한 static 메서드(객체생성 없이 바로 호출가능) 
                                                 //=  max, min,random, ceil, floor, round
        
                                                System.out.println("원주율: " + Math.PI);
                                                //결과 : 원주율: 3.141592653589793
...
round 메서드                 //round : 반올림
                            ...
                            //ex) 3.141592에서 round 메소드 써서 소수 두번째 자리 구하기?
