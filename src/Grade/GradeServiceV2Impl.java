...
import java.util.Scanner;
    ...
    public class GradeServiceV2Impl extends GradeServiceV2 {
        ...
        List<GradeVO> sjdata = new ArrayList<>();
        GradeVO sj = null;

        // 싱글톤 패턴 시작
        private static GradeServiceV2 grsrv = null;

        private GradeServiceV2Impl() {
        }

        public static GradeServiceV2 getInstance() {
            if (grsrv == null) grsrv = new GradeServiceV2Impl();
            return grsrv;
        }
        // 싱글톤 패턴 끝
        ...
        public void newGrade() {
            ...
            try {
                ...
                GradeVO sj = new GradeVO(name, kor, eng, mat);
                // 입력받은 성적데이터를 객체화함
                computeGrade(sj);
                // 성적데이터 처리
                sjdata.add(sj);
